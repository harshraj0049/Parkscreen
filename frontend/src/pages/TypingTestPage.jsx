...
const SENTENCES = [
  "A swift auburn fox leaps across the sleepy hound under the warm golden sunlight in silence",
  "Bright stars shine above the quiet village at night while a gentle breeze moves softly through trees",
  "The clever cat silently stalks the tiny mouse beneath the old table with sharp focus and patience",
  "Gentle waves wash over the soft sandy shore as the calm sea stretches endlessly beneath blue skies",
  "A bold eagle soars high in the endless blue sky, gliding with grace above mountains and valleys",
  "The young boy quickly solved the tricky puzzle using logic, patience, and careful observation skills",
  "Fresh green leaves dance in the cool autumn breeze, creating a peaceful and soothing natural rhythm",
  "A happy dog runs freely in the open field, enjoying every moment with boundless energy and joy",
  "The old clock ticks loudly in the silent room, marking time steadily with each passing second",
  "Soft rain falls gently on the calm lake surface, forming ripples that spread in quiet harmony"
];
